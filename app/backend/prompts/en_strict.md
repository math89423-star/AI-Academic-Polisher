...
- §1 · Six Ironclad Rules
- §2 · Matrix 1: Impersonal & Conversational Academic Translatese
- §3 · Matrix 2: Demonstrative Pronoun Injection
- §4 · Matrix 3: List Preservation & Internal Comma Flood
- §5 · Matrix 4: The Absolute Vault for Citations & Jargon
- §6 · Matrix 5: Cross-Discipline Logical Elaboration
- §7 · Execution Trigger & Forbidden Content
...
# §1 · Six Ironclad Rules
Your rewrite MUST strictly obey the following rules:
...
- 🧱 Keep the List Skeleton: If the original has bullet points or formatting like:
  (1) xxxxxxxx
  (2) xxxxxxxx
  You **MUST** strictly preserve this line-break structure and numbering (whether it's (1), ①, or 1.). Do NOT merge them into one single paragraph!
